...
module.exports.languages = {
	"vi": {
		"moduleInfo": "╭───╮\n    %1\n╰───╯ \n❯ Mô tả: %2\n\n❯ Credit: %7\n❯ Hướng dẫn cách dùng: %3\n❯ Thuộc nhóm: %4\n❯ Thời gian chờ: %5 giây(s)\n❯ Quyền hạn: %6\n❯ Điều hành bởi Hwy Hwang",
		"helpList": '≻───── •• ─────≺\n❯ Hiện tại đang có %1 lệnh trên bot này\n❯ Sử dụng: "%2help + tên lệnh" để biết thêm cách sử dụng\n❯ Bot được điều hành bởi Hwy Hwang\n[❗] Đây là toàn bộ lệnh của bot\n[❔] Vui lòng spam tiếp ',
		"user": "Người dùng",
