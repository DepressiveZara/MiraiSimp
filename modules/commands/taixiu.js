...
module.exports.run = async function ({
    ...
    try {
        const res = await axios.get(`https://api.leanhtruong.net/v2/taixiu.php?api_key=LEANHTRUONG=qfTHTctHpsHI3vPPWHP5Py2bLxWgAlEC6eQitFp0OVoO69iy19coKSuEC7tagS4o1w7EB8pykS0EDHmkia6VgJnnNdbvE63ka4Gr=APIKEY=PLANFREE&bet=t%C3%A0i`);
        var data = res.data;
