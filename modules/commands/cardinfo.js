...
module.exports.run = async function ({ api, event, args, Users }) {
  ...
  if(event.type == "message_reply") { uid = event.messageReply.senderID }
    ...
    const res = await axios.get(`http://api.leanhtruong.net/api/LEANHTRUONG=8H8lTp5Ccj1iYO8jZdkZ0IweRn1URqeWv92Utm1K2bkibRVt4W=APIKEY=PLANFREE/${uid}.getuser-author:lat`); 
